...
public class SynchronizationInSelenium {
    ...
    //explicit wait - can target specific element - advantages: applied to particular step; disadvantages: more code. Classes:
        //- WebDriverWait
        //-FluentWait - checks if object appears in regulat intrvals (set in fluent wait)

    //WebDriver and FluentWait are classes which are implementing Wait interface - both are under ExplixitWait which is provided by Wait interface
